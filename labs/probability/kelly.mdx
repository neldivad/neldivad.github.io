...
You notice at K=0.7, you would already outperformed a K=1 strategy 50% from the probability density chart at 100 games. 

However, if you simply observe the average results from a Monte Carlo simulations, you would have think that K=1 is the best strategy. 
