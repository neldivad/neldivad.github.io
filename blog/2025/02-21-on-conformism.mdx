...
However, this stability comes at a cost. Conformism lacks flexibility, simply because its so hard to push back against mainstream narrative. This means mistakes and wrong social directions are hard to stop -- the Pied Piper of Hamlin will lead all rats to drown in the river. 

Conformism can also be exploited, leading to potential manipulation by individuals or entities that seek to control or harm the group.
...
In fact, we could use the market perspective to understand the quantitative tradeoffs between conformism and independent thinking. 
...
[^2]: That doesn't mean now is a good time to be a conformist. I've done a deep macro research explaining how job security is a [debt-financed illusion](/blog/2025/01-05-we-cant-afford-job-security.md). 
...
Perhaps, a similar agent simulation could be used to discover the natural bias of agents towards conformism or defiance. 
